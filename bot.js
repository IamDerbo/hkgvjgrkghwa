...
client.user.setGame(`Rchelp | RC-Broadcast`,"https://discord.gg/rAcAysJ Server")
...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "help")) {
        let help = new Discord.RichEmbed()
            ...
            برودكاست عادي : RC{prefix}bc
            دعوة البوت لسيرفرك : RC{prefix}invite
            معلومات عن السيرفر : RC{prefix}server
            برودكاست للأونلاين فقط : RC{prefix}bco
            يعرض لك عدد المتبندين من سيرفرك : RC{prefix}banned
            رابط سيرفر الدعم الفني : https://discord.gg/rAcAysJ 
            **`);
